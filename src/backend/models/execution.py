...
class NL2SQLResponse(BaseModel):
    ...
    confidence_score: float = Field(
        default=0.0, ge=0.0, le=1.0, description="Confidence score from cached query match (0-1)"
    )
